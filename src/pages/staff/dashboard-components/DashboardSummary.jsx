...
const DashboardSummary = () => {
    ...
    try {
      ...
      projects.forEach(project => {
        ...
        project.phases.forEach(phase => {
          if (!phasesDistribution[phase.status]) {
            phasesDistribution[phase.status] = 0;
          }
          phasesDistribution[phase.status]++;
        });
      });
  ...
  const calculateWeeklyChange = () => {
    if (metrics.timeTracking.lastWeek === 0) return 100;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500">
              {metrics.activeProjects > 0 
                ? `${Math.round((metrics.activeProjects / metrics.totalProjects) * 100)}% of total projects` 
                : 'No active projects'}
            </p>
            <Progress 
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500">
              {metrics.overdueProjects > 0 
                ? `${Math.round((metrics.overdueProjects / metrics.totalProjects) * 100)}% of total projects` 
                : 'No overdue projects'}
            </p>
            <Progress 
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-slate-500">
              {metrics.completedThisMonth > 0 && `${metrics.completedThisMonth} project(s) completed`}
            </p>
            <Progress 
              value={100} 
